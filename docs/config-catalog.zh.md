...
来源：[`packages/host/file-browser/src/index.ts:198`](../packages/host/file-browser/src/index.ts)
...
来源：[`packages/host/workspace-git/src/index.ts:66`](../packages/host/workspace-git/src/index.ts)
...
- `@deepseek-ai/dsh-host-directory-picker-browse` — 需要 `fileBrowser`（[`packages/host/directory-picker-browse/src/index.ts`](../packages/host/directory-picker-browse/src/index.ts)）
