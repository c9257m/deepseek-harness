...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-workspace-files': { kind: 'none', reason: 'Browser-side file tree/viewer surface; registers nothing model-facing.' },
  'packages/client/ui-workspace-git': { kind: 'none', reason: 'Browser-side git quick-action surface; registers nothing model-facing.' },
  'packages/host/workspace-git': { kind: 'none', reason: 'The GUI host git service runs operations for the browser panel; registers nothing model-facing.' },
  'packages/host/file-browser': { kind: 'none', reason: 'The GUI host file service serves the browser tree and viewer; registers nothing model-facing.' },
