...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  GitStatusValue: 'GUI git service value is owned by packages/host/workspace-git/README.md',
  GitCommitValue: 'GUI git service value is owned by packages/host/workspace-git/README.md',
  GitBranchValue: 'GUI git service value is owned by packages/host/workspace-git/README.md',
  GitOutputValue: 'GUI git service value is owned by packages/host/workspace-git/README.md',
  DirectoryListing: 'GUI file-browser listing value is owned by packages/host/directory-picker/README.md',
  DirectoryEntry: 'GUI file-browser entry value is owned by packages/host/directory-picker/README.md',
