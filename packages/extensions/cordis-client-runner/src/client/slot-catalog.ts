...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workspace-files FontSizeRow id \'file-font-size\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'The workspace file-tree region: the current workspace\'s file hierarchy as a lazy tree.',
    doc: 'The workspace file-tree region: the current workspace\'s file hierarchy\nas a lazy tree. Declared by this package\'s \'sidebar\' entry; the\nworkspace-file browser package registers the tree. Rendered when the\nshell\'s browse view is "files".',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      'client-ui-workspace-files FileTree',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'sidebar.files.git',
    kind: 'single',
    scope: 'root',
    summary: 'The git quick-action panel beneath the file tree.',
    doc: 'The git quick-action panel beneath the file tree. Declared by this\npackage as the FileTree entry\'s child hole (declaring is claiming); the\nworkspace-git plugin registers the panel and receives no owner props.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'sidebar.files\' (client-ui-workspace-files), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace-git GitPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.files.git\', () => ctx.slots.register(\n      { name: \'sidebar.files.git\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace-files/src/client/contract/slots.ts:38',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace-files FileViewer',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'workspace.fileViewer\', () => ctx.slots.register(\n      { name: \'workspace.fileViewer\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
