...
export type {
  DirectoryEntry, DirectoryListing, GitBranchValue, GitCommitValue, GitDiffHunk, GitDiffLine, GitFileDiff, GitFileStatus,
  GitOutputValue, GitStatusValue, WorkspaceId, WorkspaceView,
