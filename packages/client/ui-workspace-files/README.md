...
The sidebar shell owns the sessions/files view switch (`sidebar.files` is declared there); this package only registers into the hole via `slots.inject()` for each declaration lifetime.
