...
| [`file-browser/`](file-browser/README.md) | GUI filesystem browsing: listings, reads, atomic writes | `ctx.fileBrowser` |
| [`workspace-git/`](workspace-git/README.md) | GUI git operations: status/commit/push/pull/branches/checkout | `ctx.workspaceGit` |
