...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('git-not-a-repository'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-failed'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-aborted'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-launch-failed'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-output-overflow'), message: z.string(), details: z.object({}) }),
