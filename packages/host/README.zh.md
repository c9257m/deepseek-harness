...
| [`file-browser/`](file-browser/README.md) | GUI 文件系统浏览：列表、读取、原子写入 | `ctx.fileBrowser` |
| [`workspace-git/`](workspace-git/README.md) | GUI git 操作：status/commit/push/pull/branches/checkout | `ctx.workspaceGit` |
